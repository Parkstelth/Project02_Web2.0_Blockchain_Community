...
function FrontPage({ loginClick, change, setIsLogin, appusername, userpassword, isLogin, LoginClick }) {
...
function setpost(){
    ...
    return (
        ...
        loginClick
        ?<>
        <LoginPage setIsLogin={setIsLogin} appusername={appusername} userpassword={userpassword} isLogin={isLogin} LoginClick={LoginClick}/>
